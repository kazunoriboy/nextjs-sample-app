...
type FlexProps = BoxProps & {
  ...
  alingContent?: Responsive<CSSPropertyAlignContent>
...
const Flex = styled(Box)<FlexProps>`
  ...
  ${(props) => toPropValue('aling-content', props.alingContent, props.theme)}
  ...
  ${(props) => toPropValue('flex-shirink', props.flexShrink, props.theme)}
